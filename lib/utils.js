...
exports.mergeWithDefaultChangelogRules = exports.mapCustomReleaseRules = exports.getLatestPrereleaseTag = exports.getLatestTag = exports.isPr = exports.getBranchFromRef = exports.getCommits = exports.getValidTags = exports.convertVersionFormat = void 0;
...
function getValidTags(prefixRegex, shouldFetchAllTags, isCustomVersionFormat) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isCustomVersionFormat) {
            ...
            tags = tags.map((tag) => {
                ...
                return Object.assign(Object.assign({}, tag), { name: customTag });
            });
        }
