...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const validTags = yield (0, utils_1.getValidTags)(prefixRegex, /true/i.test(shouldFetchAllTags), versionFormat);
        ...
        if (customTag) {
            ...
            previousTag.name = (0, utils_1.convertVersionFormat)(previousTag.name, versionFormat);
            if (!previousVersion) {
        ...
        const newTag = (0, utils_1.convertVersionFormat)(`${tagPrefix}${newVersion}`, versionFormat);
